...
let lastAddedCat = new Cat(defaultDataCat);
...
const searchNameDog = (req, res) => {
  ...
  return Dog.findByName(req.query.name, (err, doc) => {
    ...
    const resJson = { name: foundDog.name, breed: foundDog.breed, age: foundDog.age };

    // send back the name as a success for now
    savePromise.then(() => res.json(resJson));
...
const updateLastDog = (req, res) => {
  ...
  const resJson = { name: lastAddedDog.name, breed: lastAddedDog.breed, age: lastAddedDog.age };
